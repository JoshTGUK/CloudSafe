...
import { FaUpload, FaCheck, FaExclamationTriangle, FaClock, FaLightbulb, FaBolt } from 'react-icons/fa';
import '../shared/MaintenanceStyles.css';
import './LightingElectrical.css';

const LightingElectrical = ({ hideHeader }) => {
    ...
    <div className="maintenance-page">
      ...
      <div className="maintenance-content">
        <div className="content-header">
          <h1>Lighting & Electrical Systems</h1>
