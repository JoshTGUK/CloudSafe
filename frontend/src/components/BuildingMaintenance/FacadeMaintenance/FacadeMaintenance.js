...
import { FaUpload, FaCheck, FaExclamationTriangle, FaClock, FaBuilding } from 'react-icons/fa';
import '../shared/MaintenanceStyles.css';
import './FacadeMaintenance.css';

const FacadeMaintenance = ({ hideHeader }) => {
    ...
    <div className="maintenance-page">
      ...
      <div className="maintenance-content">
        <div className="content-header">
          <h1>Façade & External Walls</h1>
          <button className="action-button">
            <FaUpload /> Upload Assessment
          </button>
        </div>
