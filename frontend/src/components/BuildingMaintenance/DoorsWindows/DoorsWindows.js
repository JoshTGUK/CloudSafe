...
import { FaUpload, FaCheck, FaExclamationTriangle, FaClock, FaDoorOpen, FaWindowMaximize } from 'react-icons/fa';
import '../shared/MaintenanceStyles.css';
import './DoorsWindows.css';

const DoorsWindows = ({ hideHeader }) => {
    ...
    <div className="maintenance-page">
      ...
      <div className="maintenance-content">
        <div className="content-header">
          <h1>Doors & Windows Maintenance</h1>
